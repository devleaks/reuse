...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">DON</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <?= Yii::$app->user->identity->username . ($profile ? ' — '.$profile->name : '') ?>
